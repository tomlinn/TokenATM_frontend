  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="parent menu" prop="parentName">
        ...
        <el-input v-model="dataForm.parentName" v-popover:menuListPopover :readonly="true" placeholder="choose parent menu" class="menu-list__input"></el-input>
      </el-form-item>
      <el-form-item v-if="dataForm.type === 1" label="menu router" prop="url">
        <el-input v-model="dataForm.url" placeholder="menu router"></el-input>
      </el-form-item>
      <el-form-item v-if="dataForm.type !== 0" label="icon" prop="perms">
        <el-input v-model="dataForm.perms" placeholder="separated by comma, 如: user:list,user:create"></el-input>
      </el-form-item>
